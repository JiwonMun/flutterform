...
void main() {
  runApp(
    MaterialApp(
      ...
      home: MyPassword(storage: PasswordStorage()),
    ),
  );
}
...
class MyPassword extends StatefulWidget {
  ...
  MyPassword({Key key, @required this.storage}) : super(key: key);

  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<MyPassword> {
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              padding: EdgeInsets.all(20.0),
              child: RaisedButton(
                child: Text('Write to Password'),
                onPressed: () {
                  if (_passwordController.text.isNotEmpty) {
                    _writeStringToTextFile(_passwordController.text);
